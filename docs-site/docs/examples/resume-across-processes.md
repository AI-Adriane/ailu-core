...
Process 1 runs the graph with the catalog runner and saves the suspended state as JSON. A reviewer approves. Process 2 loads the state, checks the approval, and resumes. Guide: [Long-running runs](../guides/long-running.md).
